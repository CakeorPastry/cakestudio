...
local everyClipboard =
	missing("function", setclipboard or toclipboard or set_clipboard or (Clipboard and Clipboard.set))

local httprequest = missing(
	"function",
...
local writefile = missing("function", waxwritefile)
	and function(file, data, safe)
		if safe == true then
...
local readfile = missing("function", waxreadfile)
	and function(file, safe)
		if safe == true then
