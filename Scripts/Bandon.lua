...
local function findTopAnimals()
    ...
    table.sort(allAnimals, function(a,b) return a.priceValue > b.priceValue end)
    return allAnimals
end
...
local function increaseOffset(amount) floatOffset += amount end
...
if player.Character then setupAntiRagdoll() end
...
local function createUI()
 ...
 btnUp.MouseButton1Click:Connect(function() increaseOffset(0.5) end)
 btnDown.MouseButton1Click:Connect(function() decreaseOffset(0.5) end)
